...
namespace ShakySurvival.Camera
{
    public class EarthquakeCameraShaker : MonoBehaviour
    {
        ...
        private EarthquakeStrength _targetStrength;
        ...
        {
            _isActive = false;
            _targetStrength = EarthquakeStrength.Zero;
        ...
        private void UpdateShake()
        {
            ...
            if (_isActive)
            {
                targetAmplitude = Mathf.Lerp(baseAmplitude, maxAmplitude, _targetStrength.NormalizedIntensity) * stabilityMultiplier * ShakeMultiplier;
                targetFrequency = Mathf.Lerp(baseFrequency, maxFrequency, _targetStrength.FrequencyMultiplier);
            }
